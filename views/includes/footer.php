 ...
 <div class="footer">
  ...
  <script src="<?php echo base_url('admin_assets') ?>/vendor/jquery/dist/jquery.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/jquery-migrate/dist/jquery-migrate.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>

  <!-- JS Implementing Plugins -->
  <script src="<?php echo base_url('admin_assets') ?>/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/hs-form-search/dist/hs-form-search.min.js"></script>

  <script src="<?php echo base_url('admin_assets') ?>/vendor/chart.js/dist/Chart.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
  ...
  <script src="<?php echo base_url('admin_assets') ?>/vendor/tom-select/dist/js/tom-select.complete.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/clipboard/dist/clipboard.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/datatables/media/js/jquery.dataTables.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/vendor/datatables.net.extensions/select/select.min.js"></script>

  <!-- JS Front -->
  <script src="<?php echo base_url('admin_assets') ?>/js/theme.min.js"></script>
  <script src="<?php echo base_url('admin_assets') ?>/js/hs.theme-appearance-charts.js"></script>
