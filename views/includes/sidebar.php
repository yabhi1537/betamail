    ...
    <div class="navbar-vertical-container">
      <div class="navbar-vertical-footer-offset">
        ...
        <a class="navbar-brand" href="<?php echo base_url(); ?>" aria-label="Front">
          <img class="navbar-brand-logo"  src="<?php echo base_url('assets/images/bitlogo.png'); ?>" alt="Logo"
            data-hs-theme-appearance="default">
          <img class="navbar-brand-logo" src="<?php echo base_url('assets/images/bitlogo.png'); ?>" alt="Logo"
            data-hs-theme-appearance="dark">
          <img class="navbar-brand-logo-mini" src="<?php echo base_url('assets/images/bitlogo.png'); ?>" alt="Logo"
            data-hs-theme-appearance="default">
          <img class="navbar-brand-logo-mini" src="<?php echo base_url('assets/images/bitlogo.png'); ?>" alt="Logo"
            data-hs-theme-appearance="dark">
        </a>
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            <!-- Collapse -->
            <!-- <div class="nav-item">
              <a href='<?php echo base_url('dashboard') ?>' class="nav-link dropdown-toggle active"  role="button"
                data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" aria-expanded="true"
            ...
            <div id="navbarVerticalMenuPagesMenu"> -->
              ...
              <!-- Collapse -->
              <div class="nav-item">
                <!-- <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesEcommerceMenu" role="button"
                ...
                <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse "
                  ...
                  <div id="navbarVerticalMenuPagesMenuEcommerce"> -->
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle" href="#navbarVerticalMenuPagesEcommerceProductsMenu"
                    ...
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle" href="#navbarVerticalMenuPagesEcommerceOrdersMenu"
                        role="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarVerticalMenuPagesEcommerceOrdersMenu" aria-expanded="false"
                        aria-controls="navbarVerticalMenuPagesEcommerceOrdersMenu">
                        Orders
                      </a>

                      <div id="navbarVerticalMenuPagesEcommerceOrdersMenu" class="nav-collapse collapse "
                        data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                    ...
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle" href="#navbarVerticalMenuPagesEcommerceCustomersMenu"
                        role="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarVerticalMenuPagesEcommerceCustomersMenu" aria-expanded="false"
                        aria-controls="navbarVerticalMenuPagesEcommerceCustomersMenu">
                        Customers
                      </a>

                      <div id="navbarVerticalMenuPagesEcommerceCustomersMenu" class="nav-collapse collapse "
                        data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
              ...
              <!-- Collapse -->
              <!-- <div class="nav-item">
                <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesProjectMenu" role="button"
                  data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesProjectMenu" aria-expanded="false"
              ...
              <!-- <div class="nav-item">
                ...
                <div id="navbarVerticalMenuAuthentication" class="nav-collapse collapse "
                  ...
                  <div id="navbarVerticalMenuAuthenticationMenu"> -->
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuAuthenticationLoginMenu"
                        role="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarVerticalMenuAuthenticationLoginMenu" aria-expanded="false"
                        aria-controls="navbarVerticalMenuAuthenticationLoginMenu">
                        Log In
                      </a>

                      <div id="navbarVerticalMenuAuthenticationLoginMenu" class="nav-collapse collapse "
                    ...
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuAuthenticationSignupMenu"
                        role="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarVerticalMenuAuthenticationSignupMenu" aria-expanded="false"
                        aria-controls="navbarVerticalMenuAuthenticationSignupMenu">
                        Sign Up
                      </a>

                      <div id="navbarVerticalMenuAuthenticationSignupMenu" class="nav-collapse collapse "
                        data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                    ...
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuAuthenticationResetPasswordMenu"
                        role="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarVerticalMenuAuthenticationResetPasswordMenu" aria-expanded="false"
                        aria-controls="navbarVerticalMenuAuthenticationResetPasswordMenu">
                        Reset Password
                      </a>

                      <div id="navbarVerticalMenuAuthenticationResetPasswordMenu" class="nav-collapse collapse "
                        data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                    ...
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuAuthenticationEmailVerificationMenu"
                        role="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarVerticalMenuAuthenticationEmailVerificationMenu" aria-expanded="false"
                        aria-controls="navbarVerticalMenuAuthenticationEmailVerificationMenu">
                        Email Verification
                      </a>

                      <div id="navbarVerticalMenuAuthenticationEmailVerificationMenu" class="nav-collapse collapse "
                        data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                    ...
                    <!-- Collapse -->
                    <!-- <div class="nav-item">
                      <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuAuthentication2StepVerificationMenu"
                        role="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarVerticalMenuAuthentication2StepVerificationMenu" aria-expanded="false"
                        aria-controls="navbarVerticalMenuAuthentication2StepVerificationMenu">
                        2-step Verification
                      </a>

                      <div id="navbarVerticalMenuAuthentication2StepVerificationMenu" class="nav-collapse collapse "
                        data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
...
<!-- 
            ...
            <small class="bi-three-dots nav-subtitle-replacer"></small>
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('dashboard'); ?>" data-placement="left">
            ...
            <small class="bi-three-dots nav-subtitle-replacer"></small>
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('CompaignController'); ?>" data-placement="left">
                <i class="bi-calendar-week nav-icon"></i>
                <span class="nav-link-title">Send Mail</span>
              </a>
            </div>

            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('SmtpController'); ?>" data-placement="left">
                <i class="bi-kanban nav-icon"></i>
                <span class="nav-link-title">Add Smtp</span>
              </a>
            </div>

            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('SenderController');   ?>" data-placement="left">
                <i class="bi-receipt nav-icon"></i>
                <span class="nav-link-title">Sender Name</span>
              </a>
            </div>
            <small class="bi-three-dots nav-subtitle-replacer"></small>
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('SubjectController');  ?>" data-placement="left">
                <i class="bi-grid-1x2 nav-icon"></i>
                <span class="nav-link-title">Subject</span>
              </a>
            </div>

            
            <!-- <span class="dropdown-header mt-4">Subject</span> -->
            
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('BodylineController'); ?>" data-placement="left">
                <i class="bi-grid-1x2 nav-icon"></i>
                <span class="nav-link-title">Body Line</span>
              </a>
            </div>
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('UploadController'); ?>" data-placement="left">
                <i class="bi-book nav-icon"></i>
                <span class="nav-link-title">Attechment </span>
              </a>
            </div>
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('HtmlController') ?>" data-placement="left">
                <i class="bi-folder2-open nav-icon"></i>
                <span class="nav-link-title">Add Html</span>
              </a>
            </div>
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('recipient') ?>" data-placement="left">
                <i class="bi-book nav-icon"></i>
                <span class="nav-link-title">Recipient </span>
              </a>
            </div>
            <div class="nav-item">
              <a class="nav-link " href="<?php echo base_url('InvoiceController'); ?>" data-placement="left">
                <i class="bi-book nav-icon"></i>
        ...
        <div class="navbar-vertical-footer">
          <ul class="navbar-vertical-footer-list">
            <li class="navbar-vertical-footer-list-item">
              ...
              <a class="nav-link " href="<?php echo base_url('ClientQueryController');   ?>" data-placement="left">
                <i class="bi-receipt nav-icon"></i>
                <span class="nav-link-title" style='color:#fff;'>Contact us</span>
              </a>
